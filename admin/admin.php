...
function so_adminbar_render(){
	...
	?>
	<div id="siteorigin-admin-bar" data-type="<?php echo esc_attr($GLOBALS['so_adminbar_active']->id) ?>">
		<div class="inner">
			<img src="<?php echo esc_url($GLOBALS['so_adminbar_active']->icon) ?>" class="icon" width="44" height="44" />
